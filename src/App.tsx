...
const initialStudents: Student[] = [
  { id: 1, nis: "230401", name: "Andreas Benu", gender: "L", status: "Hadir", note: "" },
  { id: 2, nis: "230402", name: "Maria F.", gender: "P", status: "Hadir", note: "" },
  { id: 3, nis: "230403", name: "Yoseph K.", gender: "L", status: "Sakit", note: "Kurang sehat" },
  { id: 4, nis: "230404", name: "Yohana N.", gender: "P", status: "Hadir", note: "" },
  { id: 5, nis: "230405", name: "Fransiskus", gender: "L", status: "Izin", note: "" },
  { id: 6, nis: "230406", name: "Martha L.", gender: "P", status: "Hadir", note: "" },
  { id: 7, nis: "230407", name: "Daniel T.", gender: "L", status: "Alpa", note: "" },
  { id: 8, nis: "230408", name: "Yuliana K.", gender: "P", status: "Hadir", note: "" },
  { id: 9, nis: "230409", name: "Petrus N.", gender: "L", status: "Hadir", note: "" },
  { id: 10, nis: "230410", name: "Maria Yosefa", gender: "P", status: "Hadir", note: "" },
  { id: 11, nis: "230411", name: "Ronaldo B.", gender: "L", status: "Hadir", note: "" },
  { id: 12, nis: "230412", name: "Veronika S.", gender: "P", status: "Hadir", note: "" },
  { id: 13, nis: "230413", name: "Antonius R.", gender: "L", status: "Hadir", note: "" },
  { id: 14, nis: "230414", name: "Agustina D.", gender: "P", status: "Hadir", note: "" },
];
...
const activities = [
  { type: "success", title: "Absensi Kelas 4", by: "Yohan Deku", time: "08:45" },
  { type: "success", title: "Absensi Kelas 2", by: "Yohana B.", time: "08:30" },
  { type: "izin", title: "Izin — Maria F.", by: "Kelas 1", time: "07:55" },
  { type: "sakit", title: "Sakit — Yoseph K.", by: "Kelas 3", time: "07:40" },
  { type: "alpa", title: "Alpa — Fransiskus", by: "Kelas 4", time: "07:25" },
];
...
function App() {
  ...
  const summary = useMemo(() => {
    ...
    return {
      ...
      percentage: Math.round((counts.Hadir / students.length) * 1000) / 10,
    };
  }, [students]);
  ...
  return (
    <section className="content">
      ...
      <div className="stat-grid">
        <StatCard icon={<Users />} value="83" label="Total Siswa" detail="6 Kelas" tone="blue" />
        <StatCard icon={<Check />} value="78" label="Hadir Hari Ini" detail="94.0%" tone="green" />
        <StatCard icon={<HeartPulse />} value="2" label="Sakit" detail="2.4%" tone="orange" />
        <StatCard icon={<BookOpen />} value="1" label="Izin" detail="1.2%" tone="purple" />
        <StatCard icon={<XCircle />} value="2" label="Alpa" detail="2.4%" tone="red" />
      </div>
        ...
        <section className="panel attendance-overview">
          ...
          <div className="donut-layout">
            ...
            <div className="legend">
              <LegendRow dot="green" label="Hadir" value="78" percentage="94.0%" />
              <LegendRow dot="orange" label="Sakit" value="2" percentage="2.4%" />
              <LegendRow dot="purple" label="Izin" value="1" percentage="1.2%" />
              <LegendRow dot="red" label="Alpa" value="2" percentage="2.4%" />
        ...
        <section className="panel class-overview">
          <div className="panel-title">
            <div>
              ...
              <span>Persentase siswa hadir</span>
            </div>
          </div>
  ...
  return (
    <section className="content attendance-page">
      ...
      <div className="attendance-summary">
        <SummaryItem label="Jumlah Siswa" value={summary.total.toString()} />
        <SummaryItem label="Hadir" value={summary.Hadir.toString()} percent={`${((summary.Hadir / summary.total) * 100).toFixed(1)}%`} tone="green" />
        <SummaryItem label="Sakit" value={summary.Sakit.toString()} percent={`${((summary.Sakit / summary.total) * 100).toFixed(1)}%`} tone="orange" />
        <SummaryItem label="Izin" value={summary.Izin.toString()} percent={`${((summary.Izin / summary.total) * 100).toFixed(1)}%`} tone="purple" />
        <SummaryItem label="Alpa" value={summary.Alpa.toString()} percent={`${((summary.Alpa / summary.total) * 100).toFixed(1)}%`} tone="red" />
      </div>
